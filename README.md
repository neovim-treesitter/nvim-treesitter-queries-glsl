# nvim-treesitter-queries-glsl

[![Validate Queries](https://github.com/neovim-treesitter/nvim-treesitter-queries-glsl/actions/workflows/validate.yml/badge.svg)](https://github.com/neovim-treesitter/nvim-treesitter-queries-glsl/actions/workflows/validate.yml)

Neovim tree-sitter queries for **glsl**, part of the
...
- [ ] Changes are scoped to `glsl` — do not include files for other languages
